...
def health_components(state: AppState = Depends(get_state)) -> dict:
    ...
    components = {
        "reranker":            {"status": _enabled_or_disabled(r.rerank.enabled)},
        ...
        "kg_path":             {"status": _enabled_or_disabled(r.kg_path.enabled)},
        "kg_extraction":       {"status": _enabled_or_disabled(r.kg_extraction.enabled)},
        "query_understanding": {"status": _enabled_or_disabled(r.query_understanding.enabled)},
