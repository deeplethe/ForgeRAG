...
import from here:
    ...
    from opencraig.components import BM25Retriever, RRFFusion, Reranker
    from opencraig.client import Client
    from opencraig.eval import Dataset, LLMJudge
    from opencraig.server import create_app   # mount into your own ASGI host
...
refactors. The two namespaces coexist; ``opencraig.*`` is the stable
